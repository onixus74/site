...
function create_dom_165044() {
		...
		function HEX3Aanonymous_165063(ev_165065, n_165066) {
			var F={procname:"createDom.:anonymous",prev:framePtr,filename:"play.nim",line:0};
			framePtr = F;
				F.line = 10;
				if (lines_165030[0] != null) { lines_165030[0].push("Hello simulated universe"); } else { lines_165030[0] = ["Hello simulated universe"]; };
			framePtr = F.prev;
	...
	var F={procname:"play.createDom",prev:framePtr,filename:"play.nim",line:0};
	framePtr = F;
		F.line = 6;
		F.line = 6;
		...
		F.line = 8;
		add_135777(tmp_165061, text_137175(makeNimstrLit("Say hello!")));
		F.line = 9;
